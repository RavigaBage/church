...
if (isset($_GET['submit'])) {
    if ($_GET['submit'] != 'upload_ind' && $_GET['submit'] != 'delete_file' && $_GET['submit'] != 'delete_ini' && $_GET['submit'] != 'filter' && $_GET['submit'] != 'export') {
        $name = $_POST['name'];
    ...
    if ($_GET['submit'] == 'upload_ind' && $_GET['APICALL'] == 'true' && $_GET['user'] == 'true') {
        try {
