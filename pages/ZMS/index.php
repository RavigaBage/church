...
if ($condition) {
    ...
    <head>
        ...
        <link rel="stylesheet" href="../intl-tel-input-24.6.1/build/css/intlTelInput.css">
                    ...
                    <ul class="main">
                        ...
                        <li data-menu="projects" class="expand">
                            ...
                            <div class="tabs">
                                ...
                                <div class="item itemView home_event_itenary active"
                                    title="Event section contains all event and contribution records ">
                                    <div></div>
                                    <p>Events</p>
                                </div>
                                <div class="item itemView offertory_itenary">
                                    <div></div>
                                    <p>Offertory</p>
                                </div>
                                <a href="#Transaction">
