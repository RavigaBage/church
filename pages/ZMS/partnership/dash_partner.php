...
if (isset($_SESSION['unique_id'])) {
    $unique_id_1 = $_SESSION['unique_id'];
    $token = $_SESSION['Admin_access'];
    $known = hash('sha256', $unique_id_1 . 'admin');
    if ((hash_equals($known, $token))) {
        if (!isset($_SESSION['Partnership_Log'])) {
            $date = date('Y-m-d H:i:s');
            $newquest = $viewDataClass->DataHistory($unique_id_1, "Admin permit was used to logged in", $date, "Dashboard partnership", "Admin permit was used logged in to dashboard");
...
if ($condition) {
    ?>
        ...
        <div class="event_menu_add main form_data">
                <form>
                    ...
                    <div class="container_event">
                        ...
                        <input name="delete_key" type="text" hidden type="number"/>
        ...
        <div class="assets_page">
            <div class="content_pages">
                <div class="content_page_event">
                    <div class="records_table" id="main_table">
                        <table>
                            <thead>
                                <tr>
                                    <th>Full name</th>
        ...
        <?php
        $site = 'partnership form';
        $update = $pdh->Reset_Notification($site);
} else {
