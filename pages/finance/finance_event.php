        ...
        <nav>
            <div class="navigation_content" style="justify-content: flex-end;">
                <div class="nav_profile_link">
                    ...
                    <div class="ux_search_bar" style="position:relative;transform:translateY(0px);pointer-events:initial">
                        ...
                        <div class="content_page_event">
                            ...
                            <div class="CloneSearch" hidden>
                                ...
                                <tr>
                                    ...
                                    <td class='td_action Cloneamount'><div></div></td>
                                    ...
                                    <td class='option'>
                                        <div class='delete option'>
                                            ...
                                            <div class='opt_element'>
                                                ...
                                                <p class='delete_item dp' delete_item='" . $id . "' delete_table=''>Delete item <i></i></p>
                                            </div>
                                        </div>
                                    </td>
                                                        </tr>
