        ...
        <section>
            <nav>
                <div class="navigation_content">
                    ...
                    <header><h1 class="greeting">Good Morning, <span>john Doe</span></h1></header>
...
<div class="filter_wrapper relative">
                        ...
                        <div class="content_pages">
                            <div class="content_page_event">
                                ...
                                <div class="records_table">
                                    <table>
                                        <?php
                                        $data  =$newDataRequest->Dues_pay_list($num);
                                        if($data == 'Error Occurred'){
                                            echo "<header class='danger'>AN ERROR OCCURED !! RESTART THE PROCESS TO THIS PAGE</header>";
                                        }else{
                                            echo'
                                        <thead>
                                            <tr>
    ...
    <script>
        ...
        const OptionElements = document.querySelectorAll('td.option');
