    ...
    <div class="container">
        <div class="grid_container">
            ...
            <div class="transactions">
                ...
                <div class="container_list">
                    <?php
                    $data = $FinanceDataClass->TransactionList(0);
                            ...
                            if ($i < 5) {
                                ...
                                echo '<div class="item">
                                        <div class="cover_main">
                                            <div class="acc_name">
                                                <div class="logo"><img src="../images/' . $account . '" alt="logo" /></div>
                                                <h1>' . $account . '</h1>
                                            </div>
                                            <div class="date">
                                                <span>Category</span>
        ...
        <div class="wallet">
            ...
            <div class="display">
                ...
                <div class="content_dash">
                    ...
                    if ($data == "" || $data == 'Error Occurred' || $data == 'Not Records Available') {
                        ...
                        echo '<p>The partnership program has generated a total of <b></b> since january ' . $Year . '</p>';
                    }
                    ?>
                </div>
            </div>
            <div class="members">
                ...
                <div class="content_dash">
                    <?php
                    $memberView = $MemberDataClass->viewList(0);
