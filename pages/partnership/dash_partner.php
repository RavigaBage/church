...
<div class="filter_wrapper relative">
    <div style="height:40px;width:100%" class="flex">
        ...
        <div class="notification_list_filter">
            ...
            <div class="item_opt flex">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" ><path d="M666-440 440-666l226-226 226 226-226 226Zm-546-80v-320h320v320H120Zm400 400v-320h320v320H520Zm-400 0v-320h320v320H120Z"/></svg>
            <a style="text-decoration:none;" target="_blank" href="partnership/presentation_slides.html">Presentation</a>
            </div>
